...
Elong.stats_xz10 = SpatialStatsFFT( squeeze(Elong.phase(:,10,:)));
...
Elong.stats_yz10 = SpatialStatsFFT( squeeze(Elong.phase(10,:,:)));
...
Diag.stats_xz10 = SpatialStatsFFT( squeeze(Diag.phase(:,10,:)));
...
Diag.stats_yz10 = SpatialStatsFFT( squeeze(Diag.phase(10,:,:)));
...
Rand.stats_xz10 = SpatialStatsFFT( squeeze(Rand.phase(:,10,:)));
...
Rand.stats_yz10 = SpatialStatsFFT( squeeze(Rand.phase(10,:,:)));
